...
\documentclass[9pt,pubversion]{livecoms}
...
\author[1*]{J\'er\^ome H\'enin}
\author[2*]{Tony Leli\`evre}
\author[3*]{Michael R.  Shirts}
\author[4,5*]{Omar Valsson}
\author[6*]{Lucie Delemotte}
\affil[1]{Universit\'e Paris Cit\'e, Laboratoire de Biochimie Th\'eorique, CNRS UPR 9080, Paris, France}
\affil[2]{CERMICS, Ecole des Ponts ParisTech, INRIA, Marne-la-Vall\'ee, France}
\affil[3]{Department of Chemical and Biological Engineering, University of Colorado Boulder, Boulder, CO, USA, 80309}
\affil[4]{University of North Texas, Department of Chemistry, Denton, TX, USA}
\affil[5]{Max Planck Institute for Polymer Research, Mainz, Germany}
\affil[6]{KTH Royal Institute of Technology, Science for Life Laboratory, Stockholm, Sweden}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pubDOI{10.33011/livecoms.4.1.1583}
\pubvolume{4}
\pubissue{1}
\pubyear{2022}
\articlenum{1583}
\datereceived{10 February 2022}
...
$\downarrow$ &  \\
\textit{integrate $\vx$ at constant $\vz$} & \\
$\downarrow$ &  \\
marginal probability density $\rho(\vz)$ & free energy surface $A(\vz)$ \\
$\downarrow$ &  \\
\textit{integrate $\vz$ over $\Sigma$} & \\
$\downarrow$ &  \\
...
Take the example of a \hyperlink{ref:CV} {collective variable} measuring the distance $r$ between two particles. Here, the gradient of the \textit{\hyperlink{ref:FES} {free energy surface}} depends on the geometry of the CV. Given a complete coordinate transform from Cartesian to generalized coordinates including $r$, which is necessary to define partial derivatives with respect to $r$, one may write~\cite{Henin2010a}:
\begin{equation}
